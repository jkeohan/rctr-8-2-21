...
I'm sure everyone has either heard or worked with jQuery in their Front End Dev career.  It was first introduced in 2006 and now close to [20 million web sites](https://www.similartech.com/compare/jquery-vs-react-js) have been built using the library versue the 1 million+ for React.
...
#### <g-emoji class="g-emoji" alias="alarm_clock" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/23f0.png">⏰</g-emoji> Activity - we Do - 7min
...
:thumbsup: Take a moment to install the tool and then open `DevTools` and confirm the ollowing tabs have been added:
...
Here is the starter code we will be working with: [CodeSandbox Starter](https://codesandbox.io/s/rctr-8-2-21-getting-starter-v05qc)
...
#### <g-emoji class="g-emoji" alias="alarm_clock" fallback-src="https://github.githubassets.com/images/icons/emoji/unicode/23f0.png">⏰</g-emoji> Activity - We Do - 3min
...
Take special note that React also renamed `className` to `class`. 
